 ...
 * @author Asus
 */
public class View_Devices extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("View Device List");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Transaction ID", "Device ID", "Solar Cell", "GPS module", "dht module", "lock module"
            }
        ) {
        ...
        try {
            ...
            ResultSet rs = DatabaseAccess.view_device();
            while (rs.next()) {
        ...
        jTabbedPane1.addTab("Device", jPanel1);
