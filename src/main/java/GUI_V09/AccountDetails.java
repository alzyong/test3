...
public class AccountDetails extends javax.swing.JFrame {
    ...
    private void initComponents(String accID) {
        ArrayList<String> AccID = DatabaseAccess.SpecificAccountDisplay(accID);
        ...
        jLabel1.setText("ID: "+AccID.get(0));
        ...
        jLabel9.setText(AccID.get(8));

        jLabel11.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel11.setText(AccID.get(2));

        jLabel13.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel13.setText(AccID.get(5));

        jLabel26.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel26.setText(AccID.get(6));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        Edit_Account_Details ad2 = new Edit_Account_Details();
        ad2.setVisible(true);
        JFrame frame = new JFrame();
        frame.setVisible(false);
        dispose();
