...
public class ManageTransaction extends javax.swing.JFrame {
    ...
    private void initComponents(){
        ...
        ArrayList<String> CourierAcc = new ArrayList<String>();
        ArrayList<String> SenderAcc = new ArrayList<String>();
        ArrayList<String> ReceiverAcc = new ArrayList<String>();
        try {
            ResultSet rs = DatabaseAccess.Transaction_display();
            while (rs.next()) {
                TransactionID.add(rs.getString(1));
                ProductID.add(rs.getString(5));
                CourierAcc.add(rs.getString(6));
                SenderAcc.add(rs.getString(3));
                ReceiverAcc.add(rs.getString(8));
            }
        }
        ...
        jLabel15.setText("Courier Acc");

        jLabel30.setText("Transaction ID");
        ...
        if (ProductID.size() < 1)
        {
            ...
            jLabel23.setText(CourierAcc.get(0));
            jLabel31.setText(TransactionID.get(0));
            jLabel24.setText(SenderAcc.get(0));
            jLabel35.setText(ReceiverAcc.get(0));
        }
        ...
        if (ProductID.size() < 2)
        {
            ...
            jLabel27.setText(CourierAcc.get(1));
            jLabel44.setText(TransactionID.get(1));
            jLabel25.setText(SenderAcc.get(1));
            jLabel38.setText(ReceiverAcc.get(1));
        }
        ...
        if (ProductID.size() < 3)
        {
            ...
            jLabel33.setText(CourierAcc.get(2));
            jLabel45.setText(TransactionID.get(2));
            jLabel28.setText(SenderAcc.get(2));
            jLabel39.setText(ReceiverAcc.get(2));
        }
        ...
        if (ProductID.size() < 4)
        {
            ...
            jLabel37.setText(CourierAcc.get(3));
            jLabel46.setText(TransactionID.get(3));
            jLabel29.setText(SenderAcc.get(3));
            jLabel42.setText(ReceiverAcc.get(3));
        }
        ...
        if (ProductID.size() < 5)
        {
            ...
            jLabel41.setText(CourierAcc.get(4));
            jLabel47.setText(TransactionID.get(4));
            jLabel34.setText(SenderAcc.get(4));
            jLabel43.setText(ReceiverAcc.get(4));
        }
    ...
    private void jPanel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel9MouseClicked
        ...
        TransactionDetails t = new TransactionDetails(jLabel22.getText());
        t.setVisible(true);
        JFrame frame = new JFrame();
        frame.setVisible(false);
        dispose();
