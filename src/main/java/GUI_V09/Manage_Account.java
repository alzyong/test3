...
public class Manage_Account extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ArrayList<String> SAccID = new ArrayList<String>();
        ArrayList<String> SName = new ArrayList<String>();
        ArrayList<String> SPhone = new ArrayList<String>();
        ArrayList<String> SEmail = new ArrayList<String>();
        try {
            ResultSet rs = DatabaseAccess.Account_display(2);
            while (rs.next()) {
                SAccID.add(rs.getString(1));
                SName.add(rs.getString(5));
                SPhone.add(rs.getString(3));
                SEmail.add(rs.getString(6));
            }
        }
        ...
        ArrayList<String> RAccID = new ArrayList<String>();
        ArrayList<String> RName = new ArrayList<String>();
        ArrayList<String> RPhone = new ArrayList<String>();
        ArrayList<String> REmail = new ArrayList<String>();
        try {
            ResultSet rs = DatabaseAccess.Account_display(1);
            while (rs.next()) {
                RAccID.add(rs.getString(1));
                RName.add(rs.getString(5));
                RPhone.add(rs.getString(3));
                REmail.add(rs.getString(6));
            }
        }
        catch(SQLException ex){
            System.out.println("SQLException: " + ex.getMessage());
        ...
        ArrayList<String> CAccID = new ArrayList<String>();
        ArrayList<String> CName = new ArrayList<String>();
        ArrayList<String> CPhone = new ArrayList<String>();
        ArrayList<String> CEmail = new ArrayList<String>();
        try {
            ResultSet rs = DatabaseAccess.Account_display(3);
            while (rs.next()) {
                CAccID.add(rs.getString(1));
                CName.add(rs.getString(5));
                CPhone.add(rs.getString(3));
                CEmail.add(rs.getString(6));
            }
        }
        catch(SQLException ex){
            System.out.println("SQLException: " + ex.getMessage());
        ...
        if (SAccID.size() < 1)
        {
            ...
            jLabel22.setText(SAccID.get(0));
            jLabel23.setText(SName.get(0));
            jLabel24.setText(SPhone.get(0));
            jLabel25.setText(SEmail.get(0));
        }
        ...
        if (SAccID.size() < 2)
        {
            ...
            jLabel26.setText(SAccID.get(1));
            jLabel27.setText(SName.get(1));
            jLabel28.setText(SPhone.get(1));
            jLabel29.setText(SEmail.get(1));
        }
        ...
        if (SAccID.size() < 3)
        {
            ...
            jLabel32.setText(SAccID.get(2));
            jLabel33.setText(SName.get(2));
            jLabel34.setText(SPhone.get(2));
            jLabel35.setText(SEmail.get(2));
        }
        ...
        if (SAccID.size() < 4)
        {
            ...
            jLabel36.setText(SAccID.get(3));
            jLabel37.setText(SName.get(3));
            jLabel38.setText(SPhone.get(3));
            jLabel39.setText(SEmail.get(3));
        }
        ...
        if (SAccID.size() < 5)
        {
            ...
            jLabel40.setText(SAccID.get(4));
            jLabel41.setText(SName.get(4));
            jLabel42.setText(SPhone.get(4));
            jLabel43.setText(SEmail.get(4));
        }
        ...
        if (SAccID.size() < 6)
        {
            ...
            jLabel48.setText(SAccID.get(5));
            jLabel49.setText(SName.get(5));
            jLabel50.setText(SPhone.get(5));
            jLabel51.setText(SEmail.get(5));
        }
        ...
        if (RAccID.size() == 0)
        {
            ...
            jLabel54.setText(RAccID.get(0));
            jLabel55.setText(RName.get(0));
            jLabel56.setText(RPhone.get(0));
            jLabel57.setText(REmail.get(0));
        }
        ...
        if (RAccID.size() < 2)
        {
            ...
            jLabel59.setText(RAccID.get(1));
            jLabel60.setText(RName.get(1));
            jLabel61.setText(RPhone.get(1));
            jLabel62.setText(REmail.get(1));
        }
        ...
        if (RAccID.size() < 3)
        {
            ...
            jLabel64.setText(RAccID.get(2));
            jLabel65.setText(RName.get(2));
            jLabel66.setText(RPhone.get(2));
            jLabel67.setText(REmail.get(2));
        }
        ...
        if (RAccID.size() < 4)
        {
            ...
            jLabel69.setText(RAccID.get(3));
            jLabel70.setText(RName.get(3));
            jLabel71.setText(RPhone.get(3));
            jLabel72.setText(REmail.get(3));
        }
        ...
        if (RAccID.size() < 5)
        {
            ...
            jLabel74.setText(RAccID.get(4));
            jLabel75.setText(RName.get(4));
            jLabel76.setText(RPhone.get(4));
            jLabel77.setText(REmail.get(4));
        }
        ...
        if (RAccID.size() < 6)
        {
            ...
            jLabel79.setText(RAccID.get(5));
            jLabel80.setText(RName.get(5));
            jLabel81.setText(RPhone.get(5));
            jLabel82.setText(REmail.get(5));
        }
        ...
        if (CAccID.size() == 0)
        {
            ...
            jLabel89.setText(CAccID.get(0));
            jLabel90.setText(CName.get(0));
            jLabel91.setText(CPhone.get(0));
            jLabel92.setText(CEmail.get(0));
        }
        ...
        if (CAccID.size() < 2)
        {
            ...
            jLabel94.setText(CAccID.get(1));

            jLabel95.setText(CName.get(1));

            jLabel96.setText(CPhone.get(1));

            jLabel97.setText(CEmail.get(1));
        }
        ...
        if (CAccID.size() < 3)
        {
            ...
            jLabel99.setText(CAccID.get(2));
            jLabel100.setText(CName.get(2));
            jLabel101.setText(CPhone.get(2));
            jLabel102.setText(CEmail.get(2));
        }
        ...
        if (CAccID.size() < 4)
        {
            ...
            jLabel104.setText(CAccID.get(3));
            jLabel105.setText(CName.get(3));
            jLabel106.setText(CPhone.get(3));
            jLabel107.setText(CEmail.get(3));
        }
        ...
        if (CAccID.size() < 5)
        {
            ...
            jLabel109.setText(CAccID.get(4));
            jLabel110.setText(CName.get(4));
            jLabel111.setText(CPhone.get(4));
            jLabel112.setText(CEmail.get(4));
        }
        ...
        if (CAccID.size() < 6)
        {
            ...
            jLabel114.setText(CAccID.get(5));
            jLabel115.setText(CName.get(5));
            jLabel116.setText(CPhone.get(5));
            jLabel117.setText(CEmail.get(5));
        }
        jLabel118.setText("6");
    ...
    private void jPanel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel9MouseClicked
        ...
        AccountDetails AD = new AccountDetails(jLabel22.getText());
        AD.setVisible(true);
        JFrame frame = new JFrame();
        frame.setVisible(false);
        dispose();
